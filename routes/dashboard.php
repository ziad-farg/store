...
// the role middleware checks if the authenticated user has the required role(s) to access the routes
// here we are allowing only users with role 'super-admin' or 'admin' to access the dashboard routes
